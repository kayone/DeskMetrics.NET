...
namespace DeskMetrics.OperatingSystem.Hardware
{
    public class UnixHardware : IHardware
    {
        ...
        public virtual int ProcessorArchicteture
        {
            get
            {
        ...
        public virtual int ProcessorCores
        {
            get
            {
        ...
        public virtual double MemoryTotal
        {
            get
            {
        ...
        public virtual string ProcessorBrand
        {
            get
            {
        ...
        public virtual double ProcessorFrequency
        {
            get
            {
